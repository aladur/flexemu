...
TEST(test_filesystem, fct_path_is_absolute)
{
    ...
    EXPECT_FALSE(result);
#ifdef _WIN32
    result = fs::u8path(u8"/").is_absolute();
    EXPECT_FALSE(result);
    result = fs::u8path(u8"C:").is_absolute();
    EXPECT_FALSE(result);
    result = fs::u8path(u8"C:\\").is_absolute();
    EXPECT_TRUE(result);
    result = fs::u8path(u8"C:\\Temp").is_absolute();
    EXPECT_TRUE(result);
    result = fs::u8path(u8"C:ABC").is_absolute();
    EXPECT_FALSE(result);
    result = fs::u8path(u8"C:ABC\\..").is_absolute();
    EXPECT_FALSE(result);
    ...
    result = fs::u8path("\\dir1\\dir2").is_absolute();
    EXPECT_FALSE(result);
    result = fs::u8path(u8"z:\\\u2665Temp").is_absolute();
    EXPECT_TRUE(result);
    ...
    EXPECT_FALSE(result);
    result = fs::u8path(u8"../dir").is_absolute();
    EXPECT_FALSE(result);
    result = fs::u8path(u8"dir/").is_absolute();
    EXPECT_FALSE(result);
    result = fs::u8path(u8"/\u2665usr").is_absolute();
