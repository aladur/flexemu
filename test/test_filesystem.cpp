...
{
    auto result = fs::path(u8"").filename();
    EXPECT_EQ(result, fs::u8path(u8""));
    result = fs::path(u8".").filename();
    EXPECT_EQ(result, fs::u8path(u8"."));
    result = fs::path(u8"..").filename();
    EXPECT_EQ(result, fs::u8path(u8".."));
    result = fs::path(u8"filename").filename();
    EXPECT_EQ(result, fs::u8path(u8"filename"));
    result = fs::path(u8"filename.ext").filename();
    EXPECT_EQ(result, fs::u8path(u8"filename.ext"));
    result = fs::path(u8"filename.ext1.ext2").filename();
    ...
    EXPECT_EQ(result, fs::u8path(u8"filename\u2665.ext\u2665"));
#ifdef _WIN32
    result = fs::path(u8"C:\\").filename();
    EXPECT_EQ(result, fs::u8path(u8""));
    result = fs::path(u8"C:\\dir1\\dir2\\.").filename();
    EXPECT_EQ(result, fs::u8path(u8"."));
    result = fs::path(u8"C:\\dir1\\dir2\\..").filename();
    EXPECT_EQ(result, fs::u8path(u8".."));
    result = fs::path(u8"C:\\dir1\\dir2\\").filename();
    ...
    result = fs::path(u8"C:\\dir\\filename.ext").filename();
    EXPECT_EQ(result, fs::u8path(u8"filename.ext"));
    result = fs::path(u8"C:\\dir\\filename.ext1.ext2").filename();
    EXPECT_EQ(result, fs::u8path(u8"filename.ext1.ext2"));
    result = fs::path(u8"C:\\dir\\.filename").filename();
    EXPECT_EQ(result, fs::u8path(u8".filename"));
    result = fs::path(u8"C:\\dir\\..filename").filename();
    EXPECT_EQ(result, fs::u8path(u8"..filename"));
    const auto path = u8"C:\\dir\u2665\\filename\u2665.ext\u2665";
    result = fs::path(path).filename();
    EXPECT_EQ(result, fs::u8path(u8"filename\u2665.ext\u2665"));
#else
    result = fs::path(u8"/").filename();
    EXPECT_EQ(result, fs::u8path(u8""));
    result = fs::path(u8"/dir1/dir2/.").filename();
    EXPECT_EQ(result, fs::u8path(u8"."));
    result = fs::path(u8"/dir1/dir2/..").filename();
    EXPECT_EQ(result, fs::u8path(u8".."));
    result = fs::path(u8"/dir1/dir2/").filename();
    ...
    result = fs::path(u8"/dir1/dir2").filename();
    EXPECT_EQ(result, fs::u8path(u8"dir2"));
    result = fs::path(u8"/dir/filename.ext").filename();
    EXPECT_EQ(result, fs::u8path(u8"filename.ext"));
    result = fs::path(u8"/dir/filename.ext1.ext2").filename();
    EXPECT_EQ(result, fs::u8path(u8"filename.ext1.ext2"));
    result = fs::path(u8"/dir/.filename").filename();
    EXPECT_EQ(result, fs::u8path(u8".filename"));
    result = fs::path(u8"/dir/..filename").filename();
    EXPECT_EQ(result, fs::u8path(u8"..filename"));
...
{
    auto result = fs::path(u8"").extension();
    EXPECT_EQ(result, fs::u8path(u8""));
    result = fs::path(u8".").extension();
    EXPECT_EQ(result, fs::u8path(u8""));
    result = fs::path(u8"..").extension();
    EXPECT_EQ(result, fs::u8path(u8""));
    result = fs::path(u8"filename.ext").extension();
    EXPECT_EQ(result, fs::u8path(u8".ext"));
    result = fs::path(u8"filename.ext1.ext2").extension();
    EXPECT_EQ(result, fs::u8path(u8".ext2"));
    result = fs::path(u8"filename").extension();
    EXPECT_EQ(result, "");
    EXPECT_EQ(result, fs::u8path(u8""));
    result = fs::path(u8"filename..ext").extension();
    EXPECT_EQ(result, fs::u8path(u8".ext"));
    ...
    EXPECT_EQ(result, fs::u8path(u8".ext\u2665"));
#ifdef _WIN32
    result = fs::path(u8"C:\\").extension();
    EXPECT_EQ(result, fs::u8path(u8""));
    result = fs::path(u8"C:\\dir\\.").extension();
    EXPECT_EQ(result, fs::u8path(u8""));
    result = fs::path(u8"C:\\dir\\..").extension();
    EXPECT_EQ(result, fs::u8path(u8""));
    result = fs::path(u8"C:\\dir\\").extension();
    ...
    result = fs::path(u8"C:\\dir").extension();
    EXPECT_EQ(result, "");
    result = fs::path(u8"C:\\dir\\filename.ext").extension();
    ...
    result = fs::path(u8"/").extension();
    EXPECT_EQ(result, fs::u8path(u8""));
    result = fs::path(u8"/dir/.").extension();
    EXPECT_EQ(result, fs::u8path(u8""));
    result = fs::path(u8"/dir/..").extension();
    EXPECT_EQ(result, fs::u8path(u8""));
    result = fs::path(u8"/dir/").extension();
    ...
    result = fs::path(u8"/dir").extension();
    EXPECT_EQ(result, fs::u8path(u8""));
    result = fs::path(u8"/dir/filename.ext").extension();
    EXPECT_EQ(result, fs::u8path(u8".ext"));
    result = fs::path(u8"/dir\u2665/filename\u2665.ext\u2665").extension();
    EXPECT_EQ(result, fs::u8path(u8".ext\u2665"));
#endif
...
{
    auto result = fs::path(u8"").stem();
    EXPECT_EQ(result, fs::u8path(u8""));
    result = fs::path(u8".").stem();
    EXPECT_EQ(result, fs::u8path(u8"."));
    result = fs::path(u8"..").stem();
    EXPECT_EQ(result, fs::u8path(u8".."));
    result = fs::path(u8".ext").stem();
    EXPECT_EQ(result, fs::u8path(u8".ext"));
    result = fs::path(u8".ext1.ext2").stem();
    EXPECT_EQ(result, fs::u8path(u8".ext1"));
    result = fs::path(u8"filename").stem();
    EXPECT_EQ(result, fs::u8path(u8"filename"));
    result = fs::path(u8"filename.ext").stem();
    EXPECT_EQ(result, fs::u8path(u8"filename"));
    result = fs::path(u8"filename.ext1.ext2").stem();
    ...
    EXPECT_EQ(result, fs::u8path(u8"filename\u2665"));
#ifdef _WIN32
    result = fs::path(u8"C:\\").stem();
    EXPECT_EQ(result, fs::u8path(u8""));
    result = fs::path(u8"C:\\dir\\.").stem();
    EXPECT_EQ(result, fs::u8path(u8"."));
    result = fs::path(u8"C:\\dir\\..").stem();
    EXPECT_EQ(result, fs::u8path(u8".."));
    result = fs::path(u8"C:\\dir\\").stem();
    EXPECT_EQ(result, fs::u8path(u8""));
    result = fs::path(u8"C:\\dir\\filename").stem();
    EXPECT_EQ(result, fs::u8path(u8"filename"));
    result = fs::path(u8"C:\\dir\\filename.ext").stem();
    EXPECT_EQ(result, fs::u8path(u8"filename"));
    result = fs::path(u8"C:\\dir\\filename.ext").stem();
    EXPECT_EQ(result, fs::u8path(u8"filename"));
    result = fs::path(u8"C:\\dir\\filename.ext1.ext2").stem();
    EXPECT_EQ(result, fs::u8path(u8"filename.ext1"));
    result = fs::path(u8"C:\\dir\u2665\\filename\u2665.ext\u2665").stem();
    EXPECT_EQ(result, fs::u8path(u8"filename\u2665"));
#else
    result = fs::path(u8"/").stem();
    EXPECT_EQ(result, fs::u8path(u8""));
    result = fs::path(u8"/dir/.").stem();
    EXPECT_EQ(result, fs::u8path(u8"."));
    result = fs::path(u8"/dir/..").stem();
    EXPECT_EQ(result, fs::u8path(u8".."));
    result = fs::path(u8"/dir/").stem();
    EXPECT_EQ(result, fs::u8path(u8""));
    result = fs::path(u8"/dir/filename").stem();
    EXPECT_EQ(result, fs::u8path(u8"filename"));
    result = fs::path(u8"/dir/filename.ext").stem();
    EXPECT_EQ(result, fs::u8path(u8"filename"));
    result = fs::path(u8"/dir/filename.ext1.ext2").stem();
    EXPECT_EQ(result, fs::u8path(u8"filename.ext1"));
    result = fs::path(u8"/dir\u2665/filename\u2665.ext\u2665").stem();
    EXPECT_EQ(result, fs::u8path(u8"filename\u2665"));
#endif
...
{
    auto result = fs::path(u8"").parent_path();
    EXPECT_EQ(result, fs::u8path(u8""));
    result = fs::path(u8"filename.txt").parent_path();
    EXPECT_EQ(result, fs::u8path(u8""));
    result = fs::path(u8"filename").parent_path();
    EXPECT_EQ(result, fs::u8path(u8""));
#ifdef _WIN32
    result = fs::path(u8"C:\\").parent_path();
    EXPECT_EQ(result, fs::u8path(u8"C:\\"));
    result = fs::path(u8"C:\\dir\\").parent_path();
    EXPECT_EQ(result, fs::u8path(u8"C:\\dir"));
    result = fs::path(u8"C:\\dir\\.").parent_path();
    EXPECT_EQ(result, fs::u8path(u8"C:\\dir"));
    result = fs::path(u8"C:\\dir\\..").parent_path();
    EXPECT_EQ(result, fs::u8path(u8"C:\\dir"));
    result = fs::path(u8"C:\\dir1\\dir2\\..").parent_path();
    EXPECT_EQ(result, fs::u8path(u8"C:\\dir1\\dir2"));
    result = fs::path(u8"C:\\dir1\\dir2\\..\\..").parent_path();
    EXPECT_EQ(result, fs::u8path(u8"C:\\dir1\\dir2\\.."));
    result = fs::path(u8"C:\\dir\\filename").parent_path();
    EXPECT_EQ(result, fs::u8path(u8"C:\\dir"));
    result = fs::path(u8"C:\\dir\\filename.ext").parent_path();
    EXPECT_EQ(result, fs::u8path(u8"C:\\dir"));
    result = fs::path(u8"C:\\dir\u2665\\").parent_path();
    EXPECT_EQ(result, fs::u8path(u8"C:\\dir\u2665"));
#else
    result = fs::path(u8"/").parent_path();
    EXPECT_EQ(result, fs::u8path(u8"/"));
    result = fs::path(u8"/dir/").parent_path();
    EXPECT_EQ(result, fs::u8path(u8"/dir"));
    result = fs::path(u8"/dir/.").parent_path();
    EXPECT_EQ(result, fs::u8path(u8"/dir"));
    result = fs::path(u8"/dir/..").parent_path();
    EXPECT_EQ(result, fs::u8path(u8"/dir"));
    result = fs::path(u8"/dir1/dir2/..").parent_path();
    EXPECT_EQ(result, fs::u8path(u8"/dir1/dir2"));
    result = fs::path(u8"/dir1/dir2/../..").parent_path();
    EXPECT_EQ(result, fs::u8path(u8"/dir1/dir2/.."));
    result = fs::path(u8"/dir/filename").parent_path();
    EXPECT_EQ(result, fs::u8path(u8"/dir"));
    result = fs::path(u8"/dir/filename.ext").parent_path();
    EXPECT_EQ(result, fs::u8path(u8"/dir"));
    result = fs::path(u8"/dir\u2665/").parent_path();
    EXPECT_EQ(result, fs::u8path(u8"/dir\u2665"));
#endif
