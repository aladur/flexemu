...
TEST(test_fcinfo, default_ctor)
{
    ...
    EXPECT_EQ(tracks, 0);
    EXPECT_EQ(sectors, 0);
    info.GetTrackSector(tracks, sectors, sectors0);
    EXPECT_EQ(tracks, 0);
    EXPECT_EQ(sectors, 0);
    EXPECT_EQ(sectors0, 0);
...
TEST(test_fcinfo, get_set)
{
    ...
    EXPECT_EQ(tracks, 22);
    EXPECT_EQ(sectors, 47);
    EXPECT_EQ(sectors0, 47);
    info.SetTrackSector(44, 33, 20);
    info.GetTrackSector(tracks, sectors);
    EXPECT_EQ(tracks, 44);
    EXPECT_EQ(sectors, 33);
    info.GetTrackSector(tracks, sectors, sectors0);
    EXPECT_EQ(tracks, 44);
    EXPECT_EQ(sectors, 33);
    EXPECT_EQ(sectors0, 20);
    info.SetFree(8255);
