...
class test_hexdump : public test_DebugOutputFixture
{
public:
    template<class T>
...
TEST_F(test_hexdump, fct_get_bytes_from_hex)
{
    // Positive tests.
...
TEST_F(test_hexdump, fct_hex_dump_0)
{
...
TEST_F(test_hexdump, fct_hex_dump_1)
{
    const DWord bpl = 16U; // bytes per line
    std::vector<Byte> data;
    data.resize(32U);
...
TEST_F(test_hexdump, fct_hex_dump_2)
{
    const DWord bpl = 16U; // bytes per line
    std::vector<Byte> data;
    data.resize(16U);
...
TEST_F(test_hexdump, fct_hex_dump_3)
{
...
TEST_F(test_hexdump, fct_hex_dump_4)
{
    const DWord bpl = 8U; // bytes per line
    std::vector<Byte> data;
    data.resize(8U);
...
TEST_F(test_hexdump, fct_hex_dump_5)
{
    const DWord bpl = 8U; // bytes per line
    std::vector<Byte> data;
    data.resize(8U);
...
TEST_F(test_hexdump, fct_hex_dump_6)
{
...
TEST_F(test_hexdump, fct_hex_dump_7)
{
    const DWord bpl = 13U; // bytes per line
    std::vector<Byte> data;
    data.resize(20U);
...
TEST_F(test_hexdump, fct_hex_dump_8)
{
    const DWord bpl = 13U; // bytes per line
    std::vector<Byte> data;
    data.resize(27U);
...
// extra space each 5 bytes.
TEST_F(test_hexdump, fct_hex_dump_9)
{
    const DWord bpl = 13U; // bytes per line
    std::vector<Byte> data;
    data.resize(32U);
...
// extra space each 5 bytes.
TEST_F(test_hexdump, fct_hex_dump_10)
{
...
TEST_F(test_hexdump, fct_hex_dump_13)
{
    const DWord bpl = 16U; // bytes per line
    std::vector<Byte> data;
    data.resize(16U);
...
TEST_F(test_hexdump, fct_hex_dump_14)
{
    const DWord bpl = 13U; // bytes per line
    std::vector<Byte> data;
    data.resize(27U);
...
TEST_F(test_hexdump, fct_hex_dump_scale_1)
{
    std::stringstream stream;
    const DWord bpl = 16U; // bytes per line
...
TEST_F(test_hexdump, fct_hex_dump_scale_3)
{
    std::stringstream stream;
    const DWord bpl = 8U; // bytes per line
    flx::hex_dump_scale(stream, bpl, true, true);
...
TEST_F(test_hexdump, fct_hex_dump_scale_4)
{
    std::stringstream stream;
    const DWord bpl = 8U; // bytes per line
...
TEST_F(test_hexdump, fct_hex_dump_scale_5)
{
    std::stringstream stream;
    const DWord bpl = 8U; // bytes per line
...
// each 5 bytes.
TEST_F(test_hexdump, fct_hex_dump_scale_8)
{
    std::stringstream stream;
    const DWord bpl = 13U; // bytes per line
...
// 5 bytes.
TEST_F(test_hexdump, fct_hex_dump_scale_9)
{
    std::stringstream stream;
    const DWord bpl = 13U; // bytes per line
...
// 5 bytes.
TEST_F(test_hexdump, fct_hex_dump_scale_10)
{
    std::stringstream stream;
    const DWord bpl = 15U; // bytes per line
...
// each 5 bytes.
TEST_F(test_hexdump, fct_hex_dump_scale_14)
{
    std::stringstream stream;
    const DWord bpl = 13U; // bytes per line
    flx::hex_dump_scale(stream, bpl, true, false, 5U);
...
// 32 hex bytes, with address, with ascii, 16 bytes per line, offset 4.
TEST_F(test_hexdump, fct_get_hex_dump_properties_1)
{
...
// 16 hex bytes, with address, with ascii, 16 bytes per line, offset 0.
TEST_F(test_hexdump, fct_get_hex_dump_properties_2)
{
    using flx::HexDumpType;
...
// 4 hex bytes, with address, with ascii, 8 bytes per line, offset 2.
TEST_F(test_hexdump, fct_get_hex_dump_properties_3)
{
    using flx::HexDumpType;
...
// 8 hex bytes, with address, no ascii, 8 bytes per line, offset 0.
TEST_F(test_hexdump, fct_get_hex_dump_properties_4)
{
    using flx::HexDumpType;
...
// 8 hex bytes, no address, no ascii, 8 bytes per line, offset 0.
TEST_F(test_hexdump, fct_get_hex_dump_properties_5)
{
    using flx::HexDumpType;
...
// 20 hex bytes, with address, no ascii, 13 bytes per line, offset 9.
TEST_F(test_hexdump, fct_get_hex_dump_properties_6)
{
    using flx::HexDumpType;
...
// 20 hex bytes, with address, with ascii, 13 bytes per line, offset 9.
TEST_F(test_hexdump, fct_get_hex_dump_properties_7)
{
    using flx::HexDumpType;
...
// 27 hex bytes, with address, with ascii, 13 bytes per line, offset 4.
// extra space each 5 bytes.
TEST_F(test_hexdump, fct_get_hex_dump_properties_8)
{
    using flx::HexDumpType;
...
// extra space each 5 bytes.
TEST_F(test_hexdump, fct_get_hex_dump_properties_9)
{
    using flx::HexDumpType;
...
// extra space each 5 bytes.
TEST_F(test_hexdump, fct_get_hex_dump_properties_10)
{
    using flx::HexDumpType;
...
TEST_F(test_hexdump, fct_get_hex_dump_properties_11)
{
    using flx::HexDumpType;
...
// extra space each 3 bytes.
TEST_F(test_hexdump, fct_get_hex_dump_properties_12)
{
    using flx::HexDumpType;
...
// extra space each 8 bytes.
TEST_F(test_hexdump, fct_get_hex_dump_properties_13)
{
    using flx::HexDumpType;
...
// extra space each 5 bytes.
TEST_F(test_hexdump, fct_get_hex_dump_properties_14)
{
    using flx::HexDumpType;
...
// 32 hex bytes, with address, with ascii, 16 bytes per line, offset 4.
TEST_F(test_hexdump, fct_get_hex_dump_pos_for_addr_1)
{
    const sHexDumpPosForAddrTestPatterns patterns =
    {
    //  size   bpl  ASCI? addr? addr    extraSpace
...
// 16 hex bytes, with address, with ascii, 16 bytes per line, offset 0.
TEST_F(test_hexdump, fct_get_hex_dump_pos_for_addr_2)
{
    const sHexDumpPosForAddrTestPatterns patterns =
    {
    //  size   bpl  ASCI? addr? addr    extraSpace
...
// 4 hex bytes, with address, with ascii, 8 bytes per line, offset 2.
TEST_F(test_hexdump, fct_get_hex_dump_pos_for_addr_3)
{
    const sHexDumpPosForAddrTestPatterns patterns =
    {
    //  size  bpl ASCI? addr? addr    extraSpace
...
// 8 hex bytes, with address, no ascii, 8 bytes per line, offset 0.
TEST_F(test_hexdump, fct_get_hex_dump_pos_for_addr_4)
{
    const sHexDumpPosForAddrTestPatterns patterns =
    {
    //  size  bpl ASCI?  addr? addr   extraSpace
...
// 8 hex bytes, no address, no ascii, 8 bytes per line, offset 0.
TEST_F(test_hexdump, fct_get_hex_dump_pos_for_addr_5)
{
    const sHexDumpPosForAddrTestPatterns patterns =
    {
    //  size  bpl ASCI?  addr?  addr   extraSpace
...
// 20 hex bytes, with address, no ascii, 13 bytes per line, offset 9.
TEST_F(test_hexdump, fct_get_hex_dump_pos_for_addr_6)
{
    const sHexDumpPosForAddrTestPatterns patterns =
    {
    //  size   bpl  ASCI?  addr? addr   extraSpace
...
// 20 hex bytes, with address, with ascii, 13 bytes per line, offset 9.
TEST_F(test_hexdump, fct_get_hex_dump_pos_for_addr_7)
{
    const sHexDumpPosForAddrTestPatterns patterns =
    {
    //  size   bpl  ASCI? addr? addr   extraSpace
...
// 27 hex bytes, with address, with ascii, 13 bytes per line, offset 4.
// extra space each 5 bytes.
TEST_F(test_hexdump, fct_get_hex_dump_pos_for_addr_8)
{
    const sHexDumpPosForAddrTestPatterns patterns =
    {
    //  size   bpl  ASCI? addr? addr   extraSpace
...
// 32 hex bytes, no address, no ascii, 13 bytes per line,
// extra space each 5 bytes.
TEST_F(test_hexdump, fct_get_hex_dump_pos_for_addr_9)
{
    const sHexDumpPosForAddrTestPatterns patterns =
    {
    //  size   bpl  ASCI?  addr?  addr  extraSpace
...
// 15 hex bytes, no address, with ascii, 15 bytes per line, offset 4
// extra space each 5 bytes.
TEST_F(test_hexdump, fct_get_hex_dump_pos_for_addr_10)
{
    const sHexDumpPosForAddrTestPatterns patterns =
    {
    //  size   bpl  ASCI? addr?  addr  extraSpace
...
// 12 hex bytes, with address, with ascii, 15 bytes per line,
// extra space each 3 bytes.
TEST_F(test_hexdump, fct_get_hex_dump_pos_for_addr_11)
{
    const sHexDumpPosForAddrTestPatterns patterns =
    {
    //  size   bpl  ASCI?  addr? addr  extraSpace
...
// extra space each 3 bytes.
TEST_F(test_hexdump, fct_get_hex_dump_pos_for_addr_12)
{
    const sHexDumpPosForAddrTestPatterns patterns =
    {
    //  size   bpl  ASCI?  addr? addr  extraSpace
...
// 16 hex bytes, with address, with ascii, 16 bytes per line, offset 8.
// extra space each 8 bytes.
TEST_F(test_hexdump, fct_get_hex_dump_pos_for_addr_13)
{
    const sHexDumpPosForAddrTestPatterns patterns =
    {
    //  size   bpl  ASCI?  addr? addr  extraSpace
