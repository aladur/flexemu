...
${If} $Arch == "x64"
  ...
  File /a "${BASEDIR}\bin\x64\Release\dcrtool.exe"
  File /a "${BASEDIR}\bin\x64\Release\wxbase31u_vc_x64_custom.dll"
  File /a "${BASEDIR}\bin\x64\Release\wxmsw31u_core_vc_x64_custom.dll"
${Else}
  ...
  File /a "${BASEDIR}\bin\Win32\Release\dcrtool.exe"
  File /a "${BASEDIR}\bin\Win32\Release\wxbase31u_vc_custom.dll"
