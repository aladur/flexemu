...
const char *FlexException::errString[] =
{
    "No Error",
    "Unable to open {0}",
    "{0} is no FLEX file container",
    "No container opened",
    "No file opened",
    "Unable to format {0}",
    "Invalid container format #{0}",
    ...
    "No file \"{0}\" (container {1})",
    "Record map of {0} is full (container {1})",
    "Container {0} full when writing {1}",
    "Unable to create {0}",
    "Unable to rename {0} (container {1})",
    "Unable to remove {0} (container {1})",
    "Error reading disk space (container {0})",
    "Unable to copy {0} on itself",
    "Wrong parameter",
    "Error creating process ({0} {1})",
    "Error reading FLEX binary format",
    "Error creating temporary file {0}",
    "Container {0} is read-only",
    ...
    "Invalid usage of file container iterator",
    "File {0} has unexpected sector count {1}",
    "Container {0} is unformatted or has unknown format",
    "Unexpected side number {0}",
    "Empty files can not be copied. File {0}",
    "Error {0} on system call '{1}'",
    "Container {0} has invalid or unsupported JVC header",
};
