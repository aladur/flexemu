...
Byte Wd1793::readIo(Word offset)
{
	...
	case 1:	return tr;
	case 2: return sr;
	case 3:	if (cr & 0xf0 == 0xc0) {
			switch (byteCount) {
				case 6: dr = tr; break;
				case 5: dr = side; break;
				case 4: dr = 1; break;	// sector
				case 3: dr = 1; break;	// sector length
				case 2: dr = 0x55; break;
				case 1: dr = 0x55; break;
				default: dr = 0;
			} // switch	 
			byteCount--;
		} else {
...
void Wd1793::command(Byte command)
{
	...
	if (!(str & 0x01) || (command & 0xf0) == 0xd0) {
		...
		byteCount = 0;
		switch (cr & 0xf0) {
		case 0x00:	tr = 0;			// RESTORE
				type1 = 1;
				setIrq();
				break;
		case 0x10:	do_seek(dr);		// SEEK
				type1 = 1;
				break;
		case 0x30:	if (isStepIn)		// STEP with update
						do_seek(tr + 1);
					else
						do_seek(tr - 1);
		case 0x20:	type1 = 1;		// STEP
				setIrq();
				break;
		case 0x50:	do_seek(tr + 1);	// STEP IN with update
				isStepIn = 1;
				type1 = 1;
				break;
		case 0x40:	isStepIn = 1;
				setIrq();
				type1 = 1;
				break;
		case 0x70:	if (tr)			// STEP OUT with update
					do_seek(tr - 1);	
				isStepIn = 0;
				type1 = 1;
				break;
		case 0x60:	isStepIn = 0;		// STEP OUT
				setIrq();
				type1 = 1;
				break;
		case 0x80:	strRead = 0;
		...
		case 0x90:	byteCount = SECTOR_SIZE*16;// READ SECTOR mult.
				drq = 1;
				str = 0x03;
				break;
		case 0xa0:	if (writeProtect()) { // WRITE SECTOR
					str = 0x40;
					break;
				}
				if (recordNotFound())
		...
		case 0xb0:	if (writeProtect()) { // WRITE SECTOR mult.
					str = 0x40;
					break;
				}
				...
				str = 0x03;
				break;
		case 0xc0:	if (recordNotFound())	// READ ADDRESS
					str = 0x10;
				else {
					byteCount = 6;
					drq = 1;
				...
				break;
		case 0xd0:	drq = 0;		// FORCE INTERRUPT
				str &= 0xfc;
				byteCount = 0;	
				setIrq();
				break;
...
Byte Wd1793::seekError(Byte new_track)
{
	return 0;
}
