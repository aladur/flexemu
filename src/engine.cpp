...
flaginstr:  /* $10 and $11 instructions return here */
        ...
        switch (ireg)
        {
            ...
            case 0x1F: /* TFR */
                IMMBYTE(tb) GETREG(tw, tb >> 4) SETREG(tw, tb & 15) break;
            ...
            case 0x22: /* (L)BHI*/
                BRANCH(!(iccreg & 0x05)) break;

            case 0x23: /* (L)BLS*/
                BRANCH(iccreg & 0x05) break;

            case 0x24: /* (L)BCC*/
                BRANCH(!(iccreg & 0x01)) break;

            case 0x25: /* (L)BCS*/
                BRANCH(iccreg & 0x01) break;

            case 0x26: /* (L)BNE*/
                BRANCH(!(iccreg & 0x04)) break;

            case 0x27: /* (L)BEQ*/
                BRANCH(iccreg & 0x04) break;

            case 0x28: /* (L)BVC*/
                BRANCH(!(iccreg & 0x02)) break;

            case 0x29: /* (L)BVS*/
                BRANCH(iccreg & 0x02) break;

            case 0x2A: /* (L)BPL*/
                BRANCH(!(iccreg & 0x08)) break;
            ...
            case 0x2E: /* (L)BGT*/
                BRANCH(!(NXORV || iccreg & 0x04)) break;
            ...
            case 0x86: /*LDA immediate*/
                IMM8 LOADAC(iareg) CLV SETNZ8(iareg)
                break;
            ...
            case 0x8C: /*CMPX (CMPY CMPS) immediate */
                IMM16
                {
                    ...
                    else { dreg = isreg; } breg = GETWORD(eaddr);
                    res = dreg - breg;
                    SETSTATUSD(dreg, breg, res)
                } break;
            ...
            case 0x96: /*LDA direct*/
                DIRECT LOADAC(iareg) CLV SETNZ8(iareg)
                break;
            ...
            case 0x9D: /*JSR direct */
                DIRECT  PUSHWORD(ipcreg) ipcreg = eaddr;
                break;
            ...
            case 0xB6: /*LDA ext*/
                EXTENDED LOADAC(iareg) CLV SETNZ8(iareg)
                break;
            ...
            case 0xBD: /*JSR ext */
                EXTENDED  PUSHWORD(ipcreg) ipcreg = eaddr;
                break;
            ...
            case 0xC6: /*LDB immediate*/
                IMM8 LOADAC(ibreg) CLV SETNZ8(ibreg)
                break;
            ...
            case 0xD6: /*LDB direct*/
                DIRECT LOADAC(ibreg) CLV SETNZ8(ibreg)
                break;
            ...
            case 0xF6: /*LDB ext*/
                EXTENDED LOADAC(ibreg) CLV SETNZ8(ibreg)
                break;
