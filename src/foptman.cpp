...
constexpr const char * const FLEXDISKDIR = "DiskDirectory";
constexpr const char * const FLEXDISK0 = "Disk0Path";
constexpr const char * const FLEXDISK1 = "Disk1Path";
constexpr const char * const FLEXDISK2 = "Disk2Path";
constexpr const char * const FLEXDISK3 = "Disk3Path";
constexpr const char * const FLEXMDCRDRIVE0 = "MdcrDrive0Path";
constexpr const char * const FLEXMDCRDRIVE1 = "MdcrDrive1Path";
constexpr const char * const FLEXCOLOR = "DisplayColor";
constexpr const char * const FLEXNCOLORS = "NoOfColors";
constexpr const char * const FLEXINVERSE = "DisplayInverse";
constexpr const char * const FLEXHIMEM = "HighMemory";
constexpr const char * const FLEXFLEXIBLEMMU = "UseFlexibleMmu";
constexpr const char * const FLEXRAMEXTENSION = "UseRamExtension";
constexpr const char * const FLEXEUROCOM2V5 = "UseEurocom2V5";
constexpr const char * const FLEXUNDOCUMENTED = "UndocumentedMc6809";
constexpr const char * const FLEXRTC = "UseRTC";
constexpr const char * const FLEXFORMATDRIVE0 = "CanFormatDrive0";
constexpr const char * const FLEXFORMATDRIVE1 = "CanFormatDrive1";
constexpr const char * const FLEXFORMATDRIVE2 = "CanFormatDrive2";
constexpr const char * const FLEXFORMATDRIVE3 = "CanFormatDrive3";
#ifdef _WIN32
constexpr const char * const FLEXDOCDIR = "DocDirectory";
#endif
constexpr const char * const FLEXMONITOR = "MonitorPath";
constexpr const char * const FLEXVERSION = "Version";
...
constexpr const char * const FLEXISCONFIRMEXIT = "IsConfirmExit";
constexpr const char * const FLEXTERMINALIGNOREESC = "TerminalIgnoreESC";
constexpr const char * const FLEXTERMINALIGNORENUL = "TerminalIgnoreNUL";
constexpr const char * const FLEXTERMINALTYPE = "TerminalType";
constexpr const char * const FLEXPRINTFONT = "PrintFont";
constexpr const char * const FLEXPRINTPAGEBREAKDETECTED = "PrintPageBreakDetected";
constexpr const char * const FLEXPRINTORIENTATION = "PrintOrientation";
constexpr const char * const FLEXPRINTPAGESIZE = "PrintPageSize";
constexpr const char * const FLEXPRINTUNIT = "PrintUnit";
constexpr const char * const FLEXMAINWINDOWGEOMETRY = "MainWindowGeometry";
constexpr const char * const FLEXCPUDIALOGGEOMETRY = "CpuDialogGeometry";
constexpr const char * const FLEXPRINTOUTPUTWINDOWGEOMETRY = "PrintOutputWindowGeometry";
constexpr const char * const FLEXPRINTPREVIEWDIALOGGEOMETRY =
                    "PrintPreviewDialogGeometry";
constexpr const char * const FLEXPRINTCONFIG = "PrintConfig";
...
constexpr const char * const FLEXISDIRECTORYDISKACTIVE = "IsDirectoryDiskActive";
constexpr const char * const FLEXMEMORYWINDOWCONFIG = "MemoryWindowConfig";
        ...
        )
{
    ...
    for (auto optionId : optionIdsToWrite)
    {
        ...
        case FlexemuOptionId::CpuDialogGeometry:
            reg.SetValue(FLEXCPUDIALOGGEOMETRY, options.cpuDialogGeometry);
            break;
        ...
        bool ifNotExists /* = false */)
{
    ...
    for (auto optionId : optionIds)
    {
        ...
        case FlexemuOptionId::CpuDialogGeometry:
            optionsToWrite.cpuDialogGeometry =
                previousOptions.cpuDialogGeometry;
            break;
    ...
    rcFile.SetValue(FLEXCPUDIALOGGEOMETRY, optionsToWrite.cpuDialogGeometry);
...
void FlexemuOptions::GetOptions(struct sOptions &options)
{
    ...
    reg.GetValue(FLEXCPUDIALOGGEOMETRY, options.cpuDialogGeometry);
    ...
    rcFile.GetValue(FLEXCPUDIALOGGEOMETRY, options.cpuDialogGeometry);
